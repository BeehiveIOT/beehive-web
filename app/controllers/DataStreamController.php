...
class DataStreamController extends \BaseController
{
	...
	public function __construct(
		...
		DataStreamValidator $dataStreamValidator)
	{
	    $this->dataStreamRepo = $dataStreamRepo;
	    $this->templateRepo = $templateRepo;
	    $this->dataStreamValidator = $dataStreamValidator;
	}

	public function index($templateId)
	{
	    if (!$this->templateRepo->isOwner(Auth::id(), $templateId)) {
